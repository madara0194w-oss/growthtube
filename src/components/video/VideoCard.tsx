    ...
    <div className={cn('video-card', className)}>
      ...
      <div className="flex gap-3 mt-3">
        ...
        >
          ...
          <DropdownItem icon={<Share2 className="w-5 h-5" />} onClick={() => { navigator.clipboard.writeText(`${window.location.origin}${getVideoUrl(video.id)}`); addToast({ type: 'success', message: 'Link copied to clipboard' }) }}>
            Share
          </DropdownItem>
          <DropdownDivider />
